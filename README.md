...
If you set this value to `-1` the operation is non-blocking and only `SIGTERM` is sent immediately. In this case, the runner script needs to take care of killing the process.
