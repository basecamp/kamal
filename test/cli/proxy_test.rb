...
class CliProxyTest < CliTestCase
  ...
  test "upgrade" do
    ...
    run_command("upgrade", "-y").tap do |output|
      ...
      assert_match "docker container ls --all --filter 'name=^app-web-12345678$' --quiet | xargs -r docker stop", output
