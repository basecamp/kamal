...
class CommandsRegistryTest < ActiveSupport::TestCase
  ...
  test "registry setup" do
    ...
    assert_equal "docker start kamal-docker-registry || docker run --detach -p 127.0.0.1:5000:5000 --name kamal-docker-registry registry:3.0.0-rc.4", registry.setup.join(" ")
  end
