  ...
  def deploy_options
    {
      ...
      "health-check-protocol": proxy_config.dig("healthcheck", "protocol").presence,
      "health-check-websocket-subprotocol": proxy_config.dig("healthcheck", "websocket_subprotocol").presence,
